	...
	<div >
		<div id="myexample0" class="container" style="position:relative; height:60px; z-index: 9999">
				<div style="height:35px;">
					...
					<div style="width:45% ;text-align: center; float: left; "><h4>整租房</h4></div>
	 	...
	 	<div class="container" style="position:absolute; padding-top:1px; padding-left: 15px ;">
	 		<div class="row">
				...
				<div class="col-xs-4" style="width:60%">
					<div ><h4>谯城三里街2室1厅1卫88平米精装</h4></div>
					<div style="color: #999999"><h6>谯城-2室-三里街</h6></div>
					<div style="color: red ;">
						<div style="width: 40%;float: left;"><h5>面议</h5></div >
			...
			<hr style="width:1;border:1 dashed lime;height:1px;position:relative;top:0px;left:100;color: #999999;margin-top: 5px;margin-bottom: 5px" >
	 		...
	 		<div class="row">
				...
				<div class="col-xs-4" style="width:60%">
					<div ><h4>涡阳淮中大道王土楼1室带卫生间</h4></div>
					<div style="color: #999999"><h6>淮中大道-1室-简装</h6></div>
					<div style="color: red ;">
						<div style="width: 40%;float: left;"><h5>500元</h5></div >
						<div style="width: 50%;float: left;text-align: right;"><h6>今天-个人</h6></div>
					</div>
				</div>
			</div>
			<hr style="width:1;border:1 dashed lime;height:1px;position:relative;top:0px;left:100;color: #999999;margin-top: 5px;margin-bottom: 5px" >
	 		...
	 		<div class="row">
				...
				<div class="col-xs-4" style="width:60%">
					<div ><h4>谯城建安路3室1厅1卫</h4></div>
					<div style="color: #999999"><h6>谯城-建安路-3室</h6></div>
					<div style="color: red ;">
						<div style="width: 40%;float: left;"><h5>400元</h5></div >
			...
			<hr style="width:1;border:1 dashed lime;height:1px;position:relative;top:0px;left:100;color: #999999;margin-top: 5px;margin-bottom: 5px" >
	 		...
	 		<div class="row">
				...
				<div class="col-xs-4" style="width:60%">
					<div ><h4>亳州市药都路青年公寓1室1厅1卫</h4></div>
					<div style="color: #999999"><h6>青年公寓-1室1厅-精装</h6></div>
					<div style="color: red ;">
						<div style="width: 40%;float: left;"><h5>1200元</h5></div >
						<div style="width: 50%;float: left;text-align: right;"><h6>2015-11-17</h6></div>
					</div>
				</div>
			</div>
			<hr style="width:1;border:1 dashed lime;height:1px;position:relative;top:0px;left:100;color: #999999;margin-top: 5px;margin-bottom: 5px" >
	 		...
	 		<div class="row">
				...
				<div class="col-xs-4" style="width:60%">
					...
					<div style="color: red ;">
						<div style="width: 40%;float: left;"><h5>1200元</h5></div >
						<div style="width: 50%;float: left;text-align: right;"><h6>中介-2015-11-17</h6></div>
					</div>
				</div>
			</div>
			<hr style="width:1;border:1 dashed lime;height:1px;position:relative;top:0px;left:100;color: #999999;margin-top: 5px;margin-bottom: 5px" >
