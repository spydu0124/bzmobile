...
<body >
	<form id="form" role="form" class="form-horizontal">
		...
		<div class="form-group">
	      ...
	      <label for="houseRoom" style="width:5%; padding-left:1px;color: #999999 ;padding-right: 5px" class="col-sm-2 control-label">室</label>
	      ...
	      <label for="houseHall" style="width:5%; padding-left:1px;color: #999999 ;padding-right: 5px" class="col-sm-2 control-label">厅</label>
	      <div class="col-sm-10" style="width:14%; display: inline-block; padding-left:0px;padding-right: 0px">
		      <input type="text" name="houseHall" class="form-control" id="toiletid">
	      </div>
	      <label for="houseToilet" style="width:5%; padding-left:1px;color: #999999 ;text-align:left;padding-right: 5px;" class="col-sm-2 control-label">卫</label>
   		</div>
   		
   		<div class="form-group">
	      <label for="houseType" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型:</label>
	      <div class="col-sm-10" style="width:65%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <select id="houseNameid" name="houseName" class="form-control" style="width: 100%;">
		         <option value="">请选择类型</option>
		         <option value="" selected="selected">商品房</option>
   		...
   		<div class="form-group">
	      <label for="houseProperty" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">产&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;权:</label>
	      <div class="col-sm-10" style="width:30%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <select id="houseNameid" name="houseName" class="form-control" style="width: 100%;">
		         <option value="">请选择</option>
		         <option value="" selected="selected">70年</option>
		         <option value="">50年</option>
		         <option value="">40年</option>
		      </select>
	      </div>
	      <div class="col-sm-10" style="width:25%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <div class="col-sm-10" style="width:100%; display: inline-block;padding-left:0px;padding-right: 5px">
	      		<input type="text" name="houseFloor" class="form-control" id="floorid" placeholder="建筑年代">
	      	  </div>
	      </div>
	      <label for="houseRent11" style="width:5%; display: inline-block; text-align: left; color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">年</label>
   		</div>
   		
   		<div class="form-group">
	      <label for="houseFitment" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">装&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修:</label>
	      <div class="col-sm-10" style="width:65%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <select id="houseNameid" name="houseName" class="form-control" style="width: 100%;">
		         <option value="">请选择装修情况</option>
		         <option value="">毛坯</option>
		         <option value="">简单装修</option>
		         <option value="" selected="selected">精装修</option>
	      ...
	      <label for="houseFloor1" style="width:20%; display: inline-block; text-align: left; color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">层</label>
   		...
   		<div class="form-group">
	      <label for="houseTotalFloor" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">总&nbsp;&nbsp;楼&nbsp;&nbsp;层:</label>
	      <div class="col-sm-10" style="width:40%; display: inline-block;padding-left:0px;padding-right: 5px">
	      	<input type="text" name="houseTotalFloor" class="form-control" id="totalfloorid">
	      </div>
	      <label for="houseTotalFloor1" style="width:20%; display: inline-block; text-align: left; color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">层</label>
   		</div>
	      ...
	      <label for="houseAreaMj1" style="width:20%; display: inline-block; text-align: left; color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">平米</label>
   		...
   		<div class="form-group">
	      <label for="houseRent" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">售&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价:</label>
	      <div class="col-sm-10" style="width:40%; display: inline-block;padding-left:0px;padding-right: 5px">
	      	<input type="text" name="houseRent" class="form-control" id="rentid">
	      </div>
	      <label for="houseRent" style="width:20%; display: inline-block; text-align: left; color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">万元</label>
   		</div>
