...
<body >
	<form id="form" role="form" class="form-horizontal">
		...
		<div class="form-group">
	      ...
	      <label for="houseRoom" style="width:5%; padding-left:5px;padding-right: 5px" class="col-sm-2 control-label">室</label>
	      ...
	      <label for="houseHall" style="width:5%; padding-left:5px;padding-right: 5px" class="col-sm-2 control-label">厅</label>
	      <div class="col-sm-10" style="width:14%; display: inline-block; padding-left:0px;padding-right: 0px">
		      <input type="text" name="houseHall" class="form-control" id="toiletid">
	      </div>
	      <label for="houseToilet" style="width:5%; padding-left:5px;padding-right: 5px" class="col-sm-2 control-label">卫</label>
   		</div>
   		<div class="form-group">
	      ...
	      <label for="houseRent" style="width:20%; display: inline-block; text-align: left;color: #999999 ;padding-left:0px;padding-right: 0px;" class="col-sm-2 control-label">元/月</label>
   		</div>
   		
   		<div class="form-group">
	      <label for="houseBedroom" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">卧&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;室:</label>
	      <div class="col-sm-10" style="width:65%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <select id="houseBedroomid" name="houseName" class="form-control" style="width: 100%;">
		         <option value="">请选择</option>
		         <option value="" selected="selected">主卧</option>
		         <option value="">次卧</option>
		         <option value="">隔断</option>
		      </select>
	      </div>
   		</div>
   		
   		<div class="form-group">
	      <label for="housePersonSex" style="width:30%; display: inline-block; text-align: right;" class="col-sm-2 control-label">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:</label>
	      <div class="col-sm-10" style="width:65%; display: inline-block;padding-left:0px;padding-right: 5px;">
		      <select id="housePersonSexid" name="housePersonSex" class="form-control" style="width: 100%;">
		         <option value="">请选择</option>
		         <option value="" selected="selected">男女不限</option>
		         <option value="">限男生</option>
		         <option value="">限女生</option>
		      </select>
	      </div>
   		</div>
